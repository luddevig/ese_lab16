...
- Group 1: Cover = Character & Summary = Character
- Group 2: Cover = Character & Summary = Genre
- Group 3: Cover = Genre & Summary = Character
- Group 4: Cover = Genre & Summary = Genre
### Question b.
...
The intercept is the models estimation of the engagement value when the two factors Cover and Summary are set to 0. In this case, that is when Cover = Character and Summary = Character. 
