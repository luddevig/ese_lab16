...
**Conclusion** - Both the Cover and the interaction effect between the Cover and Summary are statistically significant. The pairwise analysis from the Tukey test suggested that any combination other than having the character in both the Cover and Summary will give the highest engagement level.   
