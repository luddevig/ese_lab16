...
**Homoscedasticity** - We have used a scale plot and the Levene's test to check for homoscedasticity, that is to verify that the variances are equal. The null hypothesis is that the population variances are equal. 
