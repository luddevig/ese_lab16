...
```{r power-analysis}
pwr.f2.test(u=5, f2=0.25, power=0.9)
...
## 1. Generating a population of size 72.
...
#This is the linear model that controls the response variable
 ...
 techdebt_out<- rnorm(N, mean=techdebt, sd = response_std) # This generates a normal distribution
...
## 4. Creating a balanced sample for each group with 12 teams in each group.
